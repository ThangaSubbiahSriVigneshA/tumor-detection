...
class Frames:
    ...
    def __init__(self, mainObj, MainWin, wWidth, wHeight, function, Object, xAxis=10, yAxis=10):
        ...
        self.MainWindow.title("Lung Nodule prediction")
        ...
        self.btnClose = tkinter.Button(self.winFrame, text="Close", width=8,command=lambda: self.quitProgram(self.MainWindow))
